...
```shell script
    ...
    "require": {   
        ...
        ...,
        ...,     
        "book-my-party/orm-module": "dev-develop",
    },
```
...
That module created based on the [orm-module]({REPO_NAME_SSH}) and module's init branch pushed to [primary module repo](https://github.com/devlubinets/laminas-primary-module).
